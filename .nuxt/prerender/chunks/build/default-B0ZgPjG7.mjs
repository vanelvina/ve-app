import { _ as __nuxt_component_1$1 } from './nuxt-link-D2oXBkcL.mjs';
import { defineComponent, mergeProps, withCtx, createTextVNode, createVNode, unref, openBlock, createBlock, toDisplayString, createCommentVNode, ref, computed, watch, nextTick, useSSRContext } from 'file://C:/Projects/Website/ve-app/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderSlot, ssrRenderAttr, ssrInterpolate, ssrRenderList, ssrRenderClass, ssrRenderStyle } from 'file://C:/Projects/Website/ve-app/node_modules/vue/server-renderer/index.mjs';
import { p as publicAssetsURL } from '../_/renderer.mjs';
import { c as categoriesData } from './categories-Cn3mOoH3.mjs';
import { u as useUIStore } from './ui-De1hAQUT.mjs';
import { u as useCartStore, f as formatPrice } from './cart-BC2fjYev.mjs';
import { b as useWishlistStore, a as useCart, _ as _sfc_main$8 } from './products-DbFjrDEZ.mjs';
import { _ as _export_sfc } from './server.mjs';
import { u as useProducts } from './useProducts-D0EBEr25.mjs';
import { _ as _sfc_main$9 } from './AppBadge-R2t0PrU7.mjs';
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_AppBadge = _sfc_main$9;
      ...
      if (unref(product)) {
        _push(`<div class="fixed inset-0 z-50 flex items-center justify-center px-4 py-8" role="dialog" aria-modal="true"${ssrRenderAttr("aria-label", `Quick view: ${unref(product).name}`)} data-v-299e05d1><div class="relative w-full max-w-3xl bg-white rounded-2xl shadow-modal overflow-hidden max-h-[90vh] flex flex-col md:flex-row" data-v-299e05d1><button class="absolute top-4 right-4 z-10 btn-icon bg-white shadow-sm" aria-label="Close quick view" data-v-299e05d1><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true" data-v-299e05d1><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" data-v-299e05d1></path></svg></button><div class="w-full md:w-2/5 shrink-0 aspect-product bg-light-gray overflow-hidden" data-v-299e05d1><img${ssrRenderAttr("src", (_a = unref(product).variants[unref(selectedVariant)]) == null ? void 0 : _a.images[0])}${ssrRenderAttr("alt", unref(product).name)} class="w-full h-full object-cover" width="400" height="533" data-v-299e05d1></div><div class="flex-1 overflow-y-auto p-5 md:p-7" data-v-299e05d1><p class="text-xs text-dusty-rose font-ui font-medium uppercase tracking-wider mb-1" data-v-299e05d1>${ssrInterpolate(unref(product).category)}</p><h2 class="font-serif text-xl text-deep-plum font-semibold mb-2" data-v-299e05d1>${ssrInterpolate(unref(product).name)}</h2>`);
        ...
        _push(`</div><div class="mb-3" data-v-299e05d1><p class="text-xs font-ui font-semibold text-charcoal uppercase tracking-wider mb-2" data-v-299e05d1> Color: <span class="normal-case font-normal text-mid-gray" data-v-299e05d1>${ssrInterpolate((_b = unref(product).variants[unref(selectedVariant)]) == null ? void 0 : _b.color)}</span></p><div class="flex gap-2" data-v-299e05d1><!--[-->`);
...
//# sourceMappingURL=default-B0ZgPjG7.mjs.map
