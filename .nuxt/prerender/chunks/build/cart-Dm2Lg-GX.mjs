...
import { defineComponent, ref, mergeProps, unref, withCtx, createTextVNode, createVNode, toDisplayString, openBlock, createBlock, useSSRContext } from 'file://C:/Projects/Website/ve-app/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrInterpolate, ssrRenderComponent, ssrRenderList, ssrRenderAttr, ssrRenderClass } from 'file://C:/Projects/Website/ve-app/node_modules/vue/server-renderer/index.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(cart).isEmpty) {
        _push(`<div class="text-center py-20"><div class="text-7xl mb-4" aria-hidden="true">\u{1F6CD}\uFE0F</div><h2 class="font-serif text-2xl text-deep-plum mb-2">Your cart is empty</h2><p class="text-mid-gray font-ui text-sm mb-8">Looks like you haven&#39;t added anything yet. Let&#39;s fix that!</p>`);
        ...
        ssrRenderList(unref(cart).items, (item) => {
          ...
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              ...
              if (_push2) {
                _push2(`<img${ssrRenderAttr("src", (_c = (_a = item.product.variants.find((v) => v.color === item.variantColor)) == null ? void 0 : _a.images[0]) != null ? _c : (_b = item.product.variants[0]) == null ? void 0 : _b.images[0])}${ssrRenderAttr("alt", item.product.name)} class="w-24 h-28 object-cover rounded-xl" width="96" height="112" loading="lazy"${_scopeId}>`);
              } else {
                return [
                  createVNode("img", {
                    src: (_f = (_d = item.product.variants.find((v) => v.color === item.variantColor)) == null ? void 0 : _d.images[0]) != null ? _f : (_e = item.product.variants[0]) == null ? void 0 : _e.images[0],
        ...
        ssrRenderList(["\u{1F512} Secure", "\u21A9\uFE0F Easy Returns", "\u{1F69A} Fast Delivery"], (badge) => {
...
//# sourceMappingURL=cart-Dm2Lg-GX.mjs.map
