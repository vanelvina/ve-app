...
import { b as useWishlistStore, _ as _sfc_main$1, a as _sfc_main$2 } from './products-Bors2uVq.mjs';
import { _ as _sfc_main$3 } from './AppButton-f0i-AWLW.mjs';
import { p as productSchema, b as breadcrumbSchema, f as faqSchema, _ as _sfc_main$4 } from './schema-DAHRKZVa.mjs';
import { _ as _sfc_main$5 } from './ProductCard-DbRZuopT.mjs';
import { defineComponent, computed, ref, watch, watchEffect, unref, mergeProps, withCtx, createTextVNode, toDisplayString, openBlock, createBlock, createVNode, useSSRContext } from 'file://C:/Project/Van%20Elvina/van-elvina/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderAttr, ssrRenderList, ssrRenderClass, ssrRenderStyle } from 'file://C:/Project/Van%20Elvina/van-elvina/node_modules/vue/server-renderer/index.mjs';
import { f as formatPrice, i as isValidPincode } from './formatters-CRqlhyd1.mjs';
...
import { u as useSeoMeta, a as useHead } from './v3-Bm7UdMXu.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(product)) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-warm-ivory min-h-screen" }, _attrs))} data-v-5c2df2ad><div class="bg-white border-b border-border-gray" data-v-5c2df2ad><div class="page-container py-3" data-v-5c2df2ad><nav aria-label="Breadcrumb" data-v-5c2df2ad><ol class="flex items-center gap-2 text-xs font-ui text-mid-gray flex-wrap" data-v-5c2df2ad><li data-v-5c2df2ad>`);
        ...
        _push(`</li><li aria-hidden="true" data-v-5c2df2ad>/</li><li data-v-5c2df2ad>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/products",
          class: "hover:text-deep-plum"
        }, {
        ...
        _push(`</li><li aria-hidden="true" data-v-5c2df2ad>/</li><li class="text-charcoal font-medium truncate max-w-[200px]" data-v-5c2df2ad>${ssrInterpolate(unref(product).name)}</li></ol></nav></div></div><div class="page-container py-6 lg:py-10" data-v-5c2df2ad><div class="grid lg:grid-cols-2 gap-8 lg:gap-12" data-v-5c2df2ad><div class="space-y-3" data-v-5c2df2ad><div class="relative aspect-product bg-light-gray rounded-2xl overflow-hidden" data-v-5c2df2ad><img${ssrRenderAttr("src", unref(activeImage))}${ssrRenderAttr("alt", unref(product).name)} class="w-full h-full object-cover transition-all duration-300" width="600" height="800" fetchpriority="high" data-v-5c2df2ad><div class="absolute top-4 left-4 flex flex-col gap-2" data-v-5c2df2ad>`);
        ...
        _push(`</div></div><div class="flex gap-2 overflow-x-auto scrollbar-hide pb-1" data-v-5c2df2ad><!--[-->`);
        ssrRenderList(unref(allImages), (img, idx) => {
          _push(`<button class="${ssrRenderClass([unref(activeImageIdx) === idx ? "border-deep-plum" : "border-transparent hover:border-border-gray", "w-16 h-16 shrink-0 rounded-xl overflow-hidden border-2 transition-all duration-200"])}"${ssrRenderAttr("aria-label", `View image ${idx + 1}`)}${ssrRenderAttr("aria-pressed", unref(activeImageIdx) === idx)} data-v-5c2df2ad><img${ssrRenderAttr("src", img)}${ssrRenderAttr("alt", `Product view ${idx + 1}`)} class="w-full h-full object-cover" width="64" height="64" loading="lazy" data-v-5c2df2ad></button>`);
        });
        _push(`<!--]--></div></div><div class="space-y-5" data-v-5c2df2ad><div data-v-5c2df2ad><p class="text-xs text-dusty-rose font-ui font-semibold uppercase tracking-wider mb-1" data-v-5c2df2ad>${ssrInterpolate(unref(product).category)}</p><h1 class="font-serif text-2xl md:text-3xl text-deep-plum font-bold leading-tight mb-2" data-v-5c2df2ad>${ssrInterpolate(unref(product).name)}</h1><div class="flex items-center gap-3 flex-wrap" data-v-5c2df2ad>`);
        ...
        _push(`<span class="text-xs text-mid-gray font-ui" data-v-5c2df2ad>SKU: ${ssrInterpolate(unref(product).sku)}</span></div></div><div class="flex items-end gap-3 pb-4 border-b border-border-gray" data-v-5c2df2ad><span class="text-3xl font-semibold text-charcoal font-sans" data-v-5c2df2ad>${ssrInterpolate(unref(formatPrice)(unref(product).price))}</span>`);
        if (unref(product).originalPrice > unref(product).price) {
          _push(`<span class="text-lg text-mid-gray line-through font-ui mb-0.5" data-v-5c2df2ad>${ssrInterpolate(unref(formatPrice)(unref(product).originalPrice))}</span>`);
        } else {
          _push(`<!---->`);
        }
        if (unref(product).discount) {
          _push(`<span class="text-sm font-semibold text-green-600 font-ui mb-0.5" data-v-5c2df2ad> You save ${ssrInterpolate(unref(formatPrice)(unref(product).originalPrice - unref(product).price))}</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div><div data-v-5c2df2ad><p class="text-sm font-ui font-semibold text-charcoal mb-2" data-v-5c2df2ad> Color: <span class="font-normal text-mid-gray" data-v-5c2df2ad>${ssrInterpolate(unref(product).variants[unref(selectedVariant)].color)}</span></p><div class="flex gap-2.5" data-v-5c2df2ad><!--[-->`);
        ssrRenderList(unref(product).variants, (variant, idx) => {
          _push(`<button class="${ssrRenderClass([unref(selectedVariant) === idx ? "border-deep-plum scale-110 shadow-md" : "border-white shadow-sm hover:scale-105", "w-8 h-8 rounded-full border-2 transition-all duration-200 cursor-pointer"])}" style="${ssrRenderStyle({ backgroundColor: variant.colorHex })}"${ssrRenderAttr("aria-label", variant.color)}${ssrRenderAttr("aria-pressed", unref(selectedVariant) === idx)} data-v-5c2df2ad></button>`);
        });
        _push(`<!--]--></div></div><div data-v-5c2df2ad><div class="flex items-center justify-between mb-2" data-v-5c2df2ad><p class="text-sm font-ui font-semibold text-charcoal" data-v-5c2df2ad> Size: <span class="font-normal text-mid-gray" data-v-5c2df2ad>${ssrInterpolate(unref(selectedSize) || "Select a size")}</span></p><button class="text-xs text-dusty-rose font-ui hover:text-deep-plum underline" data-v-5c2df2ad> Size Guide </button></div><div class="flex flex-wrap gap-2" data-v-5c2df2ad><!--[-->`);
        ssrRenderList(unref(product).variants[unref(selectedVariant)].sizes, (size) => {
          _push(`<button class="${ssrRenderClass([unref(selectedSize) === size ? "border-deep-plum bg-deep-plum text-white shadow-sm" : "border-border-gray text-charcoal hover:border-dusty-rose hover:text-dusty-rose", "min-w-[48px] px-3 py-2 border rounded-lg text-sm font-ui font-medium transition-all duration-200 cursor-pointer"])}"${ssrRenderAttr("aria-pressed", unref(selectedSize) === size)}${ssrRenderAttr("aria-label", `Size ${size}`)} data-v-5c2df2ad>${ssrInterpolate(size)}</button>`);
        });
        _push(`<!--]--></div>`);
        if (unref(sizeError)) {
          _push(`<p class="mt-1.5 text-xs text-red-500 font-ui" role="alert" data-v-5c2df2ad>Please select a size to continue.</p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div><div data-v-5c2df2ad><p class="text-sm font-ui font-semibold text-charcoal mb-2" data-v-5c2df2ad>Quantity</p><div class="flex items-center gap-3" data-v-5c2df2ad><button class="qty-btn" aria-label="Decrease quantity" data-v-5c2df2ad>\u2212</button><span class="w-8 text-center font-ui font-semibold text-charcoal" aria-live="polite" aria-label="Quantity" data-v-5c2df2ad>${ssrInterpolate(unref(qty))}</span><button class="qty-btn" aria-label="Increase quantity" data-v-5c2df2ad>+</button><span class="text-xs text-mid-gray font-ui ml-2" data-v-5c2df2ad>${ssrInterpolate(unref(product).stockCount)} in stock</span></div></div><div class="flex gap-3 pb-5 border-b border-border-gray" data-v-5c2df2ad>`);
        _push(ssrRenderComponent(_component_AppButton, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true" data-v-5c2df2ad${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" data-v-5c2df2ad${_scopeId}></path></svg> Add to Cart `);
            } else {
              return [
        ...
        _push(`<button class="${ssrRenderClass([{ "border-dusty-rose text-dusty-rose bg-rose-blush": unref(isWishlisted) }, "w-12 h-12 shrink-0 rounded-xl border-2 border-border-gray flex items-center justify-center hover:border-dusty-rose hover:text-dusty-rose transition-all"])}"${ssrRenderAttr("aria-label", unref(isWishlisted) ? "Remove from wishlist" : "Add to wishlist")}${ssrRenderAttr("aria-pressed", unref(isWishlisted))} data-v-5c2df2ad><svg class="w-5 h-5"${ssrRenderAttr("fill", unref(isWishlisted) ? "currentColor" : "none")} stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" aria-hidden="true" data-v-5c2df2ad><path stroke-linecap="round" stroke-linejoin="round" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" data-v-5c2df2ad></path></svg></button></div><div class="bg-light-gray rounded-xl p-4" data-v-5c2df2ad><p class="text-sm font-ui font-semibold text-charcoal mb-2" data-v-5c2df2ad>Check Delivery</p><div class="flex gap-2" data-v-5c2df2ad><input${ssrRenderAttr("value", unref(pincode))} type="text" maxlength="6" placeholder="Enter PIN code" class="input-base flex-1" aria-label="Enter pincode to check delivery" data-v-5c2df2ad>`);
        _push(ssrRenderComponent(_component_AppButton, {
          size: "sm",
          variant: "secondary",
        ...
        if (unref(deliveryMsg)) {
          _push(`<p class="${ssrRenderClass([unref(deliveryOk) ? "text-green-600" : "text-red-500", "mt-2 text-xs font-ui"])}" role="alert" data-v-5c2df2ad>${ssrInterpolate(unref(deliveryMsg))}</p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div><div data-v-5c2df2ad><h2 class="text-sm font-ui font-semibold text-charcoal mb-2" data-v-5c2df2ad>Product Highlights</h2><ul class="space-y-1.5" data-v-5c2df2ad><!--[-->`);
        ssrRenderList(unref(product).highlights, (h) => {
          _push(`<li class="flex items-start gap-2 text-sm font-ui text-mid-gray" data-v-5c2df2ad><svg class="w-4 h-4 text-dusty-rose shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true" data-v-5c2df2ad><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" data-v-5c2df2ad></path></svg> ${ssrInterpolate(h)}</li>`);
        });
        _push(`<!--]--></ul></div></div></div><div class="mt-12 bg-white rounded-2xl shadow-soft border border-border-gray overflow-hidden" data-v-5c2df2ad><div class="flex border-b border-border-gray overflow-x-auto scrollbar-hide" data-v-5c2df2ad><!--[-->`);
        ssrRenderList(tabs, (tab) => {
          _push(`<button class="${ssrRenderClass([unref(activeTab) === tab ? "border-deep-plum text-deep-plum" : "border-transparent text-mid-gray hover:text-charcoal", "px-6 py-4 text-sm font-ui font-medium whitespace-nowrap transition-colors border-b-2 shrink-0"])}"${ssrRenderAttr("aria-selected", unref(activeTab) === tab)} data-v-5c2df2ad>${ssrInterpolate(tab)}</button>`);
        });
        _push(`<!--]--></div><div class="p-6" data-v-5c2df2ad>`);
        if (unref(activeTab) === "Description") {
          _push(`<div data-v-5c2df2ad><p class="text-sm font-ui text-mid-gray leading-relaxed" data-v-5c2df2ad>${ssrInterpolate(unref(product).description)}</p></div>`);
        } else if (unref(activeTab) === "Fabric & Care") {
          _push(`<div class="space-y-4" data-v-5c2df2ad><div data-v-5c2df2ad><h3 class="font-ui font-semibold text-charcoal text-sm mb-2" data-v-5c2df2ad>Fabric Composition</h3><p class="text-sm text-mid-gray font-ui" data-v-5c2df2ad>${ssrInterpolate(unref(product).fabric)}</p></div><div data-v-5c2df2ad><h3 class="font-ui font-semibold text-charcoal text-sm mb-2" data-v-5c2df2ad>Care Instructions</h3><ul class="space-y-1.5" data-v-5c2df2ad><!--[-->`);
          ssrRenderList(unref(product).care, (care) => {
            _push(`<li class="flex items-center gap-2 text-sm text-mid-gray font-ui" data-v-5c2df2ad><span class="text-base" aria-hidden="true" data-v-5c2df2ad>\u{1F3F7}\uFE0F</span>${ssrInterpolate(care)}</li>`);
          });
          _push(`<!--]--></ul></div></div>`);
        } else if (unref(activeTab) === "Reviews") {
          _push(`<div data-v-5c2df2ad><div class="flex items-center gap-6 mb-6" data-v-5c2df2ad><div class="text-center" data-v-5c2df2ad><p class="font-serif text-5xl font-bold text-deep-plum" data-v-5c2df2ad>${ssrInterpolate(unref(product).rating)}</p>`);
          _push(ssrRenderComponent(_component_AppRating, {
            rating: unref(product).rating,
            class: "justify-center my-1"
          }, null, _parent));
          _push(`<p class="text-xs text-mid-gray font-ui" data-v-5c2df2ad>${ssrInterpolate(unref(product).reviewCount)} reviews</p></div><div class="flex-1" data-v-5c2df2ad><!--[-->`);
          ssrRenderList([5, 4, 3, 2, 1], (r) => {
            _push(`<div class="flex items-center gap-2 mb-1" data-v-5c2df2ad><span class="text-xs font-ui text-mid-gray w-3" data-v-5c2df2ad>${ssrInterpolate(r)}</span><svg class="w-3 h-3 star-filled" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true" data-v-5c2df2ad><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" data-v-5c2df2ad></path></svg><div class="flex-1 h-2 bg-light-gray rounded-full overflow-hidden" data-v-5c2df2ad><div class="h-full bg-soft-gold rounded-full" style="${ssrRenderStyle({ width: `${r * 18}%` })}" data-v-5c2df2ad></div></div></div>`);
          });
          _push(`<!--]--></div></div><div class="space-y-4" data-v-5c2df2ad><!--[-->`);
          ...
          _push(`<div data-v-5c2df2ad><!--[-->`);
          ssrRenderList(unref(faqs), (faq, idx) => {
            _push(`<div class="border-b border-border-gray last:border-0" data-v-5c2df2ad><button class="w-full flex items-center justify-between py-4 text-left text-sm font-ui font-medium text-charcoal hover:text-deep-plum transition-colors"${ssrRenderAttr("aria-expanded", unref(openFaq) === idx)} data-v-5c2df2ad>${ssrInterpolate(faq.question)} <svg class="${ssrRenderClass([unref(openFaq) === idx ? "rotate-180" : "", "w-4 h-4 shrink-0 transition-transform"])}" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true" data-v-5c2df2ad><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" data-v-5c2df2ad></path></svg></button>`);
            if (unref(openFaq) === idx) {
              _push(`<div class="pb-4 text-sm text-mid-gray font-ui leading-relaxed" data-v-5c2df2ad>${ssrInterpolate(faq.answer)}</div>`);
            } else {
              _push(`<!---->`);
            }
            _push(`</div>`);
        ...
        _push(`</div></div><div class="mt-12" data-v-5c2df2ad><h2 class="font-serif text-2xl text-deep-plum font-semibold mb-6" data-v-5c2df2ad>Similar Products</h2><div class="flex gap-4 overflow-x-auto scrollbar-hide pb-2" data-v-5c2df2ad><!--[-->`);
        ssrRenderList(unref(similarProducts), (p) => {
          _push(`<div class="w-48 md:w-56 shrink-0" data-v-5c2df2ad>`);
          _push(ssrRenderComponent(_component_ProductCard, { product: p }, null, _parent));
          _push(`</div>`);
        });
        _push(`<!--]--></div></div></div><div class="sticky-add-to-cart md:hidden" aria-label="Add to cart bar" data-v-5c2df2ad><div class="flex-1" data-v-5c2df2ad><p class="font-sans font-semibold text-sm text-charcoal line-clamp-1" data-v-5c2df2ad>${ssrInterpolate(unref(product).name)}</p><p class="text-xs text-dusty-rose font-ui" data-v-5c2df2ad>${ssrInterpolate(unref(formatPrice)(unref(product).price))}</p></div>`);
        _push(ssrRenderComponent(_component_AppButton, {
          size: "md",
          onClick: handleAddToCart
        }, {
        ...
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "page-container py-20 text-center" }, _attrs))} data-v-5c2df2ad><p class="font-serif text-2xl text-deep-plum mb-4" data-v-5c2df2ad>Product not found</p>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/products",
          class: "btn-primary"
        }, {
...
const _slug_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-5c2df2ad"]]);

export { _slug_ as default };
//# sourceMappingURL=_slug_-DuqSRrbs.mjs.map
