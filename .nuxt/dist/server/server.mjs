import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent, createElementBlock, provide, cloneVNode, h, defineAsyncComponent, computed, unref, Suspense, nextTick, mergeProps, ref, Fragment, useSSRContext, withCtx, createVNode, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
import { $fetch as $fetch$1 } from "C:/Projects/Website/ve-app/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "C:/Projects/Website/ve-app/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "C:/Projects/Website/ve-app/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "C:/Projects/Website/ve-app/node_modules/h3/dist/index.mjs";
import { shouldHydrate, createPinia, setActivePinia } from "pinia";
import { defu } from "C:/Projects/Website/ve-app/node_modules/defu/dist/defu.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from "vue-router";
import { hasProtocol, joinURL, parseURL, encodePath, decodePath, withQuery, isScriptProtocol } from "C:/Projects/Website/ve-app/node_modules/ufo/dist/index.mjs";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/cart-Dm2Lg-GX.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-BSTFIpY8.js")
  },
  {
    name: "checkout",
    path: "/checkout",
    meta: __nuxt_page_meta$2 || {},
    component: () => import("./_nuxt/checkout-gD7HNZXi.js")
  },
  {
    name: "thank-you",
    path: "/thank-you",
    meta: __nuxt_page_meta$1 || {},
    component: () => import("./_nuxt/thank-you-CDB3tjlM.js")
  },
  {
    name: "admin-login",
    path: "/admin/login",
    component: () => import("./_nuxt/login-Dr1xYFwv.js")
  },
  {
    name: "products",
    path: "/products",
    component: () => import("./_nuxt/index-CcEzYCUY.js")
  },
  {
    name: "admin-dashboard",
    path: "/admin/dashboard",
    meta: __nuxt_page_meta || {},
    component: () => import("./_nuxt/dashboard-Cu_3xExl.js")
  },
  {
    name: "products-slug",
    path: "/products/:slug()",
    component: () => import("./_nuxt/_slug_-CyGEnUrd.js")
  }
];
...
const layouts = {
  checkout: defineAsyncComponent(() => import("./_nuxt/checkout-Dg75qWQY.js").then((m) => m.default || m)),
  default: defineAsyncComponent(() => import("./_nuxt/default-B0ZgPjG7.js").then((m) => m.default || m))
};
