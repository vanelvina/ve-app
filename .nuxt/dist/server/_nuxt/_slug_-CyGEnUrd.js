...
import { _ as _sfc_main$1 } from "./AppBadge-R2t0PrU7.js";
import { a as useCart, b as useWishlistStore, _ as _sfc_main$2 } from "./products-DbFjrDEZ.js";
import { _ as _sfc_main$3 } from "./AppButton-f0i-AWLW.js";
import { p as productSchema, b as breadcrumbSchema, f as faqSchema, _ as _sfc_main$4 } from "./schema-BlAIJBud.js";
import { _ as _sfc_main$5 } from "./ProductCard-duDewXZZ.js";
...
import { f as formatPrice, i as isValidPincode } from "./cart-BC2fjYev.js";
      ...
      if (unref(product)) {
        ...
        if (unref(activeTab) === "Description") {
          ...
          ssrRenderList(unref(product).care, (care) => {
            _push(`<li class="flex items-center gap-2 text-sm text-mid-gray font-ui" data-v-faf7017c><span class="text-base" aria-hidden="true" data-v-faf7017c>🏷️</span>${ssrInterpolate(care)}</li>`);
          });
          _push(`<!--]--></ul></div></div>`);
...
//# sourceMappingURL=_slug_-CyGEnUrd.js.map
