...
import { u as useProductsStore, _ as _sfc_main$1 } from "./products-DbFjrDEZ.js";
import { _ as _sfc_main$2 } from "./ProductCard-duDewXZZ.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(store).totalCount === 0) {
        _push(`<div class="py-20 text-center" data-v-9cf4160f><div class="text-6xl mb-4" aria-hidden="true" data-v-9cf4160f>🔍</div><h3 class="font-serif text-xl text-deep-plum mb-2" data-v-9cf4160f>No products found</h3><p class="text-mid-gray font-ui text-sm mb-6" data-v-9cf4160f>Try adjusting your filters.</p>`);
...
//# sourceMappingURL=index-CcEzYCUY.js.map
