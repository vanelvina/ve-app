...
import { b as useWishlistStore, _ as _sfc_main$1, a as _sfc_main$2 } from "./products-Bors2uVq.js";
import { _ as _sfc_main$3 } from "./AppButton-f0i-AWLW.js";
import { p as productSchema, b as breadcrumbSchema, f as faqSchema, _ as _sfc_main$4 } from "./schema-DAHRKZVa.js";
import { _ as _sfc_main$5 } from "./ProductCard-DbRZuopT.js";
import { defineComponent, computed, ref, watch, watchEffect, unref, mergeProps, withCtx, createTextVNode, toDisplayString, openBlock, createBlock, createVNode, useSSRContext } from "vue";
...
import { f as formatPrice, i as isValidPincode } from "./formatters-CRqlhyd1.js";
...
import { u as useCart } from "./useCart-B731HVld.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const similarProducts = computed(
      () => all.value.filter((p) => p.category === product.value?.category && p.id !== product.value?.id).slice(0, 6)
    );
      ...
      if (unref(product)) {
        ...
        if (unref(activeTab) === "Description") {
          ...
          ssrRenderList(unref(product).care, (care) => {
            _push(`<li class="flex items-center gap-2 text-sm text-mid-gray font-ui" data-v-5c2df2ad><span class="text-base" aria-hidden="true" data-v-5c2df2ad>🏷️</span>${ssrInterpolate(care)}</li>`);
          });
          _push(`<!--]--></ul></div></div>`);
...
//# sourceMappingURL=_slug_-DuqSRrbs.js.map
