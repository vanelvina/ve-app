...
import { u as useProductsStore, a as _sfc_main$1 } from "./products-Bors2uVq.js";
import { _ as _sfc_main$2 } from "./ProductCard-DbRZuopT.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(store).totalCount === 0) {
        _push(`<div class="py-20 text-center" data-v-ccec8b64><div class="text-6xl mb-4" aria-hidden="true" data-v-ccec8b64>🔍</div><h3 class="font-serif text-xl text-deep-plum mb-2" data-v-ccec8b64>No products found</h3><p class="text-mid-gray font-ui text-sm mb-6" data-v-ccec8b64>Try adjusting your filters.</p>`);
...
//# sourceMappingURL=index-DfXBC4Ho.js.map
