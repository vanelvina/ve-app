import { _ as __nuxt_component_1$1 } from "./nuxt-link-CUeF3yRu.js";
import { defineComponent, mergeProps, withCtx, createVNode, unref, createTextVNode, toDisplayString, openBlock, createBlock, createCommentVNode, useSSRContext, ref, computed, watch, nextTick } from "vue";
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderAttr, ssrRenderList, ssrInterpolate, ssrRenderClass, ssrRenderStyle, ssrRenderSlot } from "vue/server-renderer";
...
import { b as useWishlistStore, a as _sfc_main$7, _ as _sfc_main$8 } from "./products-Bors2uVq.js";
import { _ as _export_sfc } from "../server.mjs";
import { f as formatPrice } from "./formatters-CRqlhyd1.js";
...
import { _ as __nuxt_component_6 } from "./ToastNotifications-CIWmlby1.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", _imports_0)} alt="Van Elvina Logo" class="h-9 md:h-11 w-auto object-contain"${_scopeId}><span class="hidden md:block text-[8px] font-ui font-normal tracking-[0.2em] text-dusty-rose uppercase mb-1.5"${_scopeId}>Women Comfort First</span>`);
          } else {
            return [
              createVNode("img", {
                src: _imports_0,
              ...
              createVNode("span", { class: "hidden md:block text-[8px] font-ui font-normal tracking-[0.2em] text-dusty-rose uppercase mb-1.5" }, "Women Comfort First")
            ];
          }
        }),
        _: 1
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(product)) {
        _push(`<div class="fixed inset-0 z-50 flex items-center justify-center px-4 py-8" role="dialog" aria-modal="true"${ssrRenderAttr("aria-label", `Quick view: ${unref(product).name}`)} data-v-9437d48b><div class="relative w-full max-w-3xl bg-white rounded-2xl shadow-modal overflow-hidden max-h-[90vh] flex flex-col md:flex-row" data-v-9437d48b><button class="absolute top-4 right-4 z-10 btn-icon bg-white shadow-sm" aria-label="Close quick view" data-v-9437d48b><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true" data-v-9437d48b><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" data-v-9437d48b></path></svg></button><div class="w-full md:w-2/5 shrink-0 aspect-product bg-light-gray overflow-hidden" data-v-9437d48b><img${ssrRenderAttr("src", unref(product).variants[unref(selectedVariant)]?.images[0])}${ssrRenderAttr("alt", unref(product).name)} class="w-full h-full object-cover" width="400" height="533" data-v-9437d48b></div><div class="flex-1 overflow-y-auto p-5 md:p-7" data-v-9437d48b><p class="text-xs text-dusty-rose font-ui font-medium uppercase tracking-wider mb-1" data-v-9437d48b>${ssrInterpolate(unref(product).category)}</p><h2 class="font-serif text-xl text-deep-plum font-semibold mb-2" data-v-9437d48b>${ssrInterpolate(unref(product).name)}</h2>`);
        ...
        _push(`</div><div class="mb-3" data-v-9437d48b><p class="text-xs font-ui font-semibold text-charcoal uppercase tracking-wider mb-2" data-v-9437d48b> Color: <span class="normal-case font-normal text-mid-gray" data-v-9437d48b>${ssrInterpolate(unref(product).variants[unref(selectedVariant)]?.color)}</span></p><div class="flex gap-2" data-v-9437d48b><!--[-->`);
...
//# sourceMappingURL=default-BuuMG74z.js.map
