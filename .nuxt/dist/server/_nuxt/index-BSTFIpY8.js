...
import { defineComponent, ref, mergeProps, unref, withCtx, createVNode, useSSRContext, computed, createTextVNode, toDisplayString, openBlock, createBlock, watch } from "vue";
import { ssrRenderAttrs, ssrRenderStyle, ssrRenderList, ssrRenderComponent, ssrRenderAttr, ssrRenderClass, ssrInterpolate, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual } from "vue/server-renderer";
import "C:/Projects/Website/ve-app/node_modules/hookable/dist/index.mjs";
import { _ as _export_sfc } from "../server.mjs";
import { _ as _sfc_main$e } from "./ProductCard-duDewXZZ.js";
import { u as useProducts } from "./useProducts-D0EBEr25.js";
import { _ as _sfc_main$f } from "./AppBadge-R2t0PrU7.js";
import { _ as _sfc_main$g, o as organizationSchema } from "./schema-BlAIJBud.js";
import { u as useSeoMeta, a as useHead } from "./v3-B1OjdVjd.js";
...
import "./products-DbFjrDEZ.js";
import "./cart-BC2fjYev.js";
...
const _sfc_main$7 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><div class="absolute inset-0 bg-gradient-to-tr from-rose-blush/10 to-transparent pointer-events-none"></div><div class="page-container relative z-10"><div class="section-heading mb-6"><p class="text-xs font-ui font-bold text-dusty-rose uppercase tracking-[0.25em] mb-1">${ssrInterpolate(__props.widget?.subtitle || "Find Your Style")}</p><h2 id="categories-heading" class="text-2xl md:text-3xl text-deep-plum font-serif font-bold">${ssrInterpolate(__props.widget?.title || "Shop By Category")}</h2><p class="text-xs text-charcoal/60 mt-1">${ssrInterpolate(__props.widget?.description || "Explore our full range — from everyday essentials to special occasion pieces.")}</p></div><div class="flex gap-4 md:gap-6 overflow-x-auto pb-2 scrollbar-hide w-full justify-start md:justify-center items-start snap-x snap-mandatory"><!--[-->`);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(mergeProps({
        ...
        "aria-labelledby": `promo-heading-${__props.widget?.key}`
      }, _attrs))}><div class="page-container">`);
      if (__props.widget?.title || __props.widget?.subtitle) {
        _push(`<div class="section-heading mb-8">`);
        if (__props.widget?.subtitle) {
        ...
        _push(`<h2${ssrRenderAttr("id", `promo-heading-${__props.widget?.key}`)} class="font-serif text-2xl md:text-3xl text-deep-plum font-bold">${ssrInterpolate(__props.widget.title)}</h2>`);
        if (__props.widget?.description) {
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(mergeProps({
        class: "section-padding bg-white",
        "aria-labelledby": `tabs-heading-${__props.widget?.key}`
      ...
      _push(`<h2${ssrRenderAttr("id", `tabs-heading-${__props.widget?.key}`)} class="font-serif text-2xl md:text-3xl text-deep-plum font-bold" data-v-06a0e138>${ssrInterpolate(__props.widget?.title || "Shop Curated Collections")}</h2>`);
      if (__props.widget?.description) {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(mergeProps({
        ...
        "aria-labelledby": `fit-heading-${__props.widget?.key}`
      }, _attrs))} data-v-658fdd62><div class="page-container" data-v-658fdd62><div class="bg-white rounded-3xl overflow-hidden border border-rose-blush/20 shadow-card flex flex-col lg:flex-row min-h-[360px]" data-v-658fdd62><div class="lg:w-1/2 relative min-h-[240px] lg:min-h-[auto] bg-warm-ivory" data-v-658fdd62><img${ssrRenderAttr("src", __props.widget?.image || "https://images.unsplash.com/photo-1509631179647-0177331693ae?w=800&q=80")} alt="Women styling size guide" class="absolute inset-0 w-full h-full object-cover" data-v-658fdd62><div class="absolute inset-0 bg-deep-plum/20" data-v-658fdd62></div></div><div class="lg:w-1/2 p-8 md:p-12 flex flex-col justify-center space-y-6" data-v-658fdd62><div data-v-658fdd62>`);
      if (__props.widget?.subtitle) {
      ...
      _push(`<h2${ssrRenderAttr("id", `fit-heading-${__props.widget?.key}`)} class="font-serif text-2xl md:text-3.5xl text-deep-plum font-bold leading-tight" data-v-658fdd62>${ssrInterpolate(__props.widget?.title || "Calculate Your Perfect Bra Fit")}</h2><p class="text-charcoal/70 text-sm leading-relaxed mt-4" data-v-658fdd62>${ssrInterpolate(__props.widget?.description || "80% of women wear the wrong bra size. Take our 60-second sizing test to find your exact match and shop with confidence.")}</p></div><div data-v-658fdd62><button class="inline-flex items-center gap-2 px-8 py-3.5 bg-deep-plum text-white rounded-full font-ui font-semibold text-xs tracking-wider uppercase shadow-md hover:bg-plum-800 hover:shadow-lg transition-all duration-250 pulse-button" data-v-658fdd62>${ssrInterpolate(__props.widget?.items?.btnText || "Start Sizing Test")} <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true" data-v-658fdd62><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7" data-v-658fdd62></path></svg></button></div></div></div></div>`);
      if (unref(showModal)) {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(mergeProps({
        ...
        "aria-labelledby": `offers-heading-${__props.widget?.key}`
      ...
      _push(`<h2${ssrRenderAttr("id", `offers-heading-${__props.widget?.key}`)} class="font-serif text-2xl md:text-3xl text-deep-plum font-bold">${ssrInterpolate(__props.widget?.title || "Special Packs & Combos")}</h2>`);
      if (__props.widget?.description) {
        _push(`<p class="text-charcoal/65 mt-1 text-sm">${ssrInterpolate(__props.widget.description)}</p>`);
      } else {
        _push(`<!---->`);
...
//# sourceMappingURL=index-BSTFIpY8.js.map
