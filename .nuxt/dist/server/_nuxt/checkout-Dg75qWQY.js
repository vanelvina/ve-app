...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</main><footer class="bg-white border-t border-border-gray py-6 text-center"><p class="text-xs text-mid-gray font-ui"> © 2025 Van Elvina. All rights reserved. `);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/privacy-policy",
...
//# sourceMappingURL=checkout-Dg75qWQY.js.map
