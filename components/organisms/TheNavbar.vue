      ...
      >
        <div class="flex items-center gap-1.5">
          <button
            v-if="!isHomepage"
            @click="router.back()"
            class="flex items-center justify-center w-8 h-8 rounded-lg hover:bg-[#EDE4DC]/60 active:scale-95 transition-all duration-150 -ml-1 shrink-0"
            aria-label="Go back"
          >
            <!-- Public folder SVG: back-arrow-navigation-svgrepo-com.svg (currentColor = charcoal/60) -->
            <svg
